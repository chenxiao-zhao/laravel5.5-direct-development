...
class CreateVmAlgoParameterHistoryTable extends Migration {
	...
	public function up()
	{
		Schema::create('vm_algo_parameter_history', function(Blueprint $table)
		{
			...
			$table->timestamp('history_time')->nullable()->default(DB::raw('CURRENT_TIMESTAMP'))->comment('历史记录生成时间');
	...
	{
		Schema::drop('vm_algo_parameter_history');
	}
