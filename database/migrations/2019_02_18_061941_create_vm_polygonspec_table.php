...
class CreateVmPolygonspecTable extends Migration {
	...
	public function up()
	{
		Schema::create('vm_polygonspec', function(Blueprint $table)
		{
			$table->integer('id', true)->comment('自增主键');
			$table->string('name', 64)->comment('名称');
			$table->integer('camera_id')->index('camera_id_idx')->comment('摄像头id');
			$table->integer('zone_id')->nullable()->index('zone_id_idx')->comment('对应zone的id');
